    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Acerca de nosotros
                    <small>Un gusto conocerlo</small>
                </h1>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-sm-6 text-center">
                <img class="img-circle img-responsive img-center" src="img/adrianOchoa200x200.jpg" alt="Foto de Adrian Ochoa">
                <h3>Adrián Ochoa
            ...
            <div class="col-lg-6 col-sm-6 text-center">
                <img class="img-circle img-responsive img-center" src="img/aranoUno200x200.jpg" alt="Foto de Manuel Arano">
                <h3>Manuel Arano
